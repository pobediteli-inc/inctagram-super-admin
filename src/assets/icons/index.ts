...
export { default as Github } from "./GithubSvgRepoCom31";
export { default as Google } from "./GoogleSvgRepoCom1";
...
export { default as Paypal } from "./PaypalSvgrepoCom4";
